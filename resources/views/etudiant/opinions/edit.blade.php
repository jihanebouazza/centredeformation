    ...
    <div class="flex justify-between">
        ...
        <div class="flex-1 mx-4 my-8 flex items-center justify-center">
            <div class="flex-col items-center w-[60%] justify-center">
                ...
                <div class="">
                    <form action="/opinions/{{ $opinion->id }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mt-2">
                            ...
                            <div class="mt-1">
                                <textarea type="text" name="commentaire" id="commentaire"
                                    class="block focus:ring-4 w-full px-3 py-[10px] border border-gray1 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray2 focus:border-1 focus:border-gray2 sm:text-sm">{{ $opinion->commentaire }}</textarea>
                            </div>
                        </div>
                </div>
